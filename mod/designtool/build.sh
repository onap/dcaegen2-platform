...
cd nifi/nifi-docker/dockermaven
mkdir target
mv ../../nifi-assembly/target/nifi-$NIFI_VERSION-bin.zip target/
mv ../../nifi-toolkit/nifi-toolkit-assembly/target/nifi-toolkit-$NIFI_VERSION-bin.zip target/
