...
import com.att.blueprintgenerator.exception.FixesException;
...
public class FixesService {
	...
	public void fixDcaeSingleQuotes(File file) throws IOException {
	...
	public String fixStringQuotes(String string) {
		...
		for(String line: sLines) {
			if(line.contains("get_input") || line.contains("get_secret"))
				line = line.replaceAll("'", "");
