...
public class ExternalTlsInfoFactory extends ExternalCertificateDataFactory<ExternalTlsInfo> {
	ExternalCertificateParametersFactory externalCertificateParametersFactory;
