...
public class ExternalTlsInfo {
	...
	private static final String USE_EXTERNAL_TLS_FIELD = "use_external_tls";
	...
	static Map<String, LinkedHashMap<String, Object>> createInputMapFromComponentSpec(ComponentSpec cs){
		...
		retInputs.putAll(ExternalCertificateParameters.createInputMapFromComponentSpec(cs));
		return retInputs;
	}
	...
	public static class ExternalCertificateParameters {
		...
		private static Map<String, LinkedHashMap<String, Object>> createInputMapFromComponentSpec(ComponentSpec cs){
