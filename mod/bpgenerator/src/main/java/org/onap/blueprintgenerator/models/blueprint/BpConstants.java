...
public final class BpConstants {
    ...
    public static final String TOPIC = "ccsdk.nodes.Topic";
    public static final String PUBLISH_EVENTS = "ccsdk.relationships.publish_events";
    public static final String PUBLISH_FILES = "dcaegen2.relationships.publish_files";
    public static final String SUBSCRIBE_TO_EVENTS = "ccsdk.relationships.subscribe_to_events";
    public static final String SUBSCRIBE_TO_FILES = "ccsdk.relationships.subscribe_to_files";
