...
public abstract class ExternalCertificateDataFactory<T extends ExternalCertificateData> {
    ...
    protected abstract Map<String, LinkedHashMap<String, Object>> createInputListFromComponentSpec(ComponentSpec cs);
}
