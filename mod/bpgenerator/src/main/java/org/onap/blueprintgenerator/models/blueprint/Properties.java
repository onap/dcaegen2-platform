...
import org.onap.blueprintgenerator.common.blueprint.Manipulation;
...
public class Properties {
    ...
    public TreeMap<String, LinkedHashMap<String, Object>> createOnapProperties(TreeMap<String, LinkedHashMap<String, Object>> inps, ComponentSpec cs, String override) {
        ...
        location.setBpFieldName("location_id");
        ...
        replica.setBpFieldName("replicas");
        this.setReplicas(replica);
        LinkedHashMap<String, Object> rep = Manipulation.createInputValue("integer", "number of instances", 1);
...
//		}
        ...
        this.always_pull_image.setBpFieldName("always_pull_image");
        LinkedHashMap<String, Object> inputAlwaysPullImage = Manipulation.createInputValue("boolean",
    ...
    public TreeMap<String, LinkedHashMap<String, Object>> createDmaapProperties(TreeMap<String, LinkedHashMap<String, Object>> inps, ComponentSpec cs, String override) {
        ...
        //set the image
        GetInput image = new GetInput();
        image.setBpFieldName("tag_version");
        this.setImage(image);
        LinkedHashMap<String, Object> img = new LinkedHashMap<String, Object>();
        img.put("type", "string");
        img.put("default", cs.getArtifacts()[0].getUri());
...
//		}
    ...
    private void addTlsInfo(ComponentSpec cs, TreeMap<String, LinkedHashMap<String, Object>> retInputs) {
        ...
        useTLSFlag.setBpFieldName("use_tls");
        tlsInfo.setUseTls(useTLSFlag);
        this.setTls_info(tlsInfo);
        LinkedHashMap<String, Object> useTlsFlagInput = Manipulation.createInputValue("boolean",
    ...
    private Map<String, LinkedHashMap<String, Object>> addExternalTlsInfo(ComponentSpec cs) {
        ...
        ExternalTlsInfoFactory externalTlsInfoFactory = new ExternalTlsInfoFactory(externalCertificateDataFactory);
        this.setExternal_tls_info(externalTlsInfoFactory.createFromComponentSpec(cs));
        return externalTlsInfoFactory.createInputListFromComponentSpec(cs);
    }
