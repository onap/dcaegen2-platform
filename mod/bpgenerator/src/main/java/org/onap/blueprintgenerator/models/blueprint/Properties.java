...
public class Properties {
    ...
    private ExternalTlsInfoFactory externalTlsInfoFactory;

    public Properties() {
        ExternalCertificateParametersFactory externalCertificateDataFactory = new ExternalCertificateParametersFactory();
        externalTlsInfoFactory = new ExternalTlsInfoFactory(externalCertificateDataFactory);
    }
...
//		}
        ...
        if (cs.getAuxilary().getTls_info() != null) {
            ...
            if (cs.getAuxilary().getTls_info().get(USE_EXTERNAL_TLS_FIELD) != null) {
