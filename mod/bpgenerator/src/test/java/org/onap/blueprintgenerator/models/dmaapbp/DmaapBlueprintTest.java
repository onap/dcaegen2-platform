...
public class DmaapBlueprintTest {
    ...
    public static final String MOCKED_NAME = "sample.name";
    public static final String MESSAGE_ROUTER_TYPE_1 = "message_router";
    public static final String MESSAGE_ROUTER_TYPE_2 = "message router";
    public static final String DATA_ROUTER_TYPE_1 = "data_router";
    public static final String DATA_ROUTER_TYPE_2 = "data router";
    public static final String CONFIG_KEY_1 = "Configkey1";
    public static final String CONFIG_KEY_2 = "Configkey2";

    public static final String TOPIC_NODE_1 = CONFIG_KEY_1 + "_topic";
    public static final String TOPIC_NODE_2 = CONFIG_KEY_2 + "_topic";
    public static final String FEED_NODE_1 = CONFIG_KEY_1 + "_feed";
    public static final String FEED_NODE_2 = CONFIG_KEY_2 + "_feed";

    public static final String SAMPLE_FORMAT = "Format";
    public static final String SAMPLE_VERSION = "1.0.0";
    public static final String SAMPLE_ROUTE = "SampleRoute";
    public static final String SAMPLE_DESCRIPTION = "sample description";
    public static final String SAMPLE_PORTS = "8080:8080";
    public static final String SAMPLE_ARTIFACT_TYPE = "test";
    public static final String SAMPLE_ARTIFACT_URI = "test_uri";
