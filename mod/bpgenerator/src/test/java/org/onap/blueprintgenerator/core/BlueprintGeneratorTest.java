...
public class BlueprintGeneratorTest {
    ...
    public void externalTlsInfoTest() {
        ...
        assertContainsInputWithDefault(bp, "external_tls_ca_name", inQuotes(DEFAULT_CA));
        assertContainsInputWithDefault(bp, "external_tls_common_name", inQuotes(DEFAULT_COMMON_NAME));
        assertContainsInputWithDefault(bp, "external_tls_sans", inQuotes(DEFAULT_SANS));
