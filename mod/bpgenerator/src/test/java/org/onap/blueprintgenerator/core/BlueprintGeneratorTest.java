...
public class BlueprintGeneratorTest {
    ...
    public void externalTlsInfoTest() {
        ComponentSpec cs = new ComponentSpec();
        cs.createComponentSpecFromFile("TestCases/TlsInfo/testComponentSpec_withTlsTrueAndExternalTlsTrue.json");

        Blueprint bp = new Blueprint();
        bp = bp.createBlueprint(cs, "", 'o', "", "");

        //should create proper inputs
        assertContainsInputWithDefault(bp, "external_cert_use_external_tls", true);
        assertContainsInputWithDefault(bp, "external_cert_ca_name", inQuotes(DEFAULT_CA));
        assertContainsInputWithDefault(bp, "external_cert_common_name", inQuotes(DEFAULT_COMMON_NAME));
        assertContainsInputWithDefault(bp, "external_cert_sans", inQuotes(DEFAULT_SANS));
    ...
    public void noExternalTlsInfoTest() {
        ComponentSpec cs = new ComponentSpec();
        cs.createComponentSpecFromFile("TestCases/TlsInfo/testComponentSpec_withTlsTrueAndNoExternalTls.json");

        Blueprint bp = new Blueprint();
        bp = bp.createBlueprint(cs, "", 'o', "", "");

        //should not create inputs for external cert
