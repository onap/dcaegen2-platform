...
import com.att.blueprintgenerator.model.common.*;
...
import com.att.blueprintgenerator.model.dmaap.TlsInfo;
import com.att.blueprintgenerator.service.base.BlueprintHelperService;
import com.att.blueprintgenerator.service.dmaap.StreamsService;
...
public class PropertiesService {
    ...
    public Map<String,Object> createOnapProperties(Map<String, LinkedHashMap<String, Object>> inputs, OnapComponentSpec onapComponentSpec, String override) {
        ...
        if(tls_info != null) {
            ...
            if (tls_info.get(Constants.USE_EXTERNAL_TLS_FIELD) != null) {
                inputs.putAll(addExternalTlsInfo(onapComponentSpec));
            }
        }
    ...
    private Map<String, LinkedHashMap<String, Object>> addExternalTlsInfo(OnapComponentSpec onapComponentSpec) {
