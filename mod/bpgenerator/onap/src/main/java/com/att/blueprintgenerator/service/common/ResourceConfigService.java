...
import com.att.blueprintgenerator.model.common.ResourceConfig;
...
public class ResourceConfigService {
    ...
    public Map<String,Object> createResourceConfig(Map<String, LinkedHashMap<String, Object>> inputs, String name){
        ...
        LinkedHashMap<String, Object> memoryLimit = blueprintHelperService.createStringInput("string",Constants.MEMORY_LIMIT_128Mi);

        LinkedHashMap<String, Object> cpuLimit  = blueprintHelperService.createStringInput("string", Constants.CPU_LIMIT_250m);
