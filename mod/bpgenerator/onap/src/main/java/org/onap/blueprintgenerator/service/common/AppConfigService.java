...
public class AppConfigService {
    ...
    private LinkedHashMap<String, Object> createInputFromParameter(Parameters parameter) {
        ...
        if (parameter.getType() == null) {
            return blueprintHelperService.createStringInput(parameter.getValue());
        }

        switch (parameter.getType()) {
            case "boolean":
                return blueprintHelperService.createBooleanInput(parameter.getValue());
            case "integer":
                return blueprintHelperService.createIntegerInput(parameter.getValue());
            default:
                return blueprintHelperService.createStringInput(parameter.getValue());
        }
    }
