...
public class TlsInfoTest  extends BlueprintGeneratorTests {
	...
	private String componentSpecPath = Paths.get("src", "test", "resources", "componentspecs").toAbsolutePath().toString() + "\\";
	private String useTlsTrueAndUseExternalTlsTrueTest = componentSpecPath + "testComponentSpec_withTlsTrueAndExternalTlsTrue.json";
	private String useTlsFalseAndUseExternalTlsFalseTest = componentSpecPath + "testComponentSpec_withTlsFalseAndExternalTlsFalse.json";
	private String useTlsTrueAndNoExternalTlsFlagTest = componentSpecPath + "testComponentSpec_withTlsTrueAndNoExternalTls.json";
	private String noTlsInfo = componentSpecPath + "testComponentSpec_withoutTlsInfo.json";
	...
	public void useTlsTrueAndUseExternalTlsTrueTest(){
		...
		OnapBlueprint bp = createBlueprintFromFile(useTlsTrueAndUseExternalTlsTrueTest);
	...
	public void useTlsFalseAndUseExternalTlsFalseTest(){
		OnapBlueprint bp = createBlueprintFromFile(useTlsFalseAndUseExternalTlsFalseTest);
	...
	public void useTlsTrueAndNoExternalTlsFlagTest(){
		OnapBlueprint bp = createBlueprintFromFile(useTlsTrueAndNoExternalTlsFlagTest);
	...
	public void noTlsInfo(){
		OnapBlueprint bp = createBlueprintFromFile(noTlsInfo);
