...
$JAVA_HOME/bin/java -classpath $CLASSPATH -Dlogback.configurationFile=$DTI/config/logger/logback.xml -Dhttps.protocols=TLSv1.2 com.att.vcc.inventorycollector.InitAaiData INITDATA
