...
class ConsulClient(object):
    ...
    _logger = logging.getLogger("dti_handler.consul_client")
...
if __name__ == "__main__":
    ...
    # Equivalent to existing CBS /service_component/<scn>
    # value = ConsulClient.get_service_component('03dfc0cf63684e8b9e044ae75c42c9de_docker-highlandpark')

    # Equivalent to existing CBS /service_component_all/<scn>
    # value = ConsulClient.get_service_component_all('0b231f372c6f42a89817a097549f4af5_green-eggs-and-ham')
    # value = ConsulClient.get_service_component_all('03dfc0cf63684e8b9e044ae75c42c9de_docker-highlandpark')
    # value = ConsulClient.get_service_component_all('aj8568.02f5c10d-4e90-4631-9269-9aef3c81e1d9.1-0-0.dcae-controller-sdprocessor')

    # ...but I prefer this format, keeping the policy_ids
    # value = ConsulClient.get_service_component_all('0b231f372c6f42a89817a097549f4af5_green-eggs-and-ham', policies_as_list=False)

    # Equivalent to existing CBS /dti/<scn>
    # value = ConsulClient.get_value('0b231f372c6f42a89817a097549f4af5_green-eggs-and-ham:dti')


    # Get latest DTI events for all VNF Instances, nested by VNF Type (I prefer this)
    # value = ConsulClient.get_kvs('0b231f372c6f42a89817a097549f4af5_green-eggs-and-ham:dti_events/', trim_prefix=True)

    # Get latest DTI events for all VNF Type/VNF Instance, not nested
    # value = ConsulClient.get_kvs('0b231f372c6f42a89817a097549f4af5_green-eggs-and-ham:dti_events/', nest=False, trim_prefix=True)

    # Get latest DTI events for all VNF Instances of one VNF Type
    # value = ConsulClient.get_kvs('0b231f372c6f42a89817a097549f4af5_green-eggs-and-ham:dti_events/anot-her/', trim_prefix=True)

    # Get latest DTI event for one VNF Instance of one VNF Type
    # value = ConsulClient.get_value('0b231f372c6f42a89817a097549f4af5_green-eggs-and-ham:dti_events/anot-her/zrdm3avhss01ems044')


    # Get all policies, without path (I prefer this)
    # value = ConsulClient.get_kvs('0b231f372c6f42a89817a097549f4af5_green-eggs-and-ham:policies/items/', trim_prefix=True)
    # value = ConsulClient.get_kvs('0b231f372c6f42a89817a097549f4af5_green-eggs-and-ham:policies/items/', nest=False, trim_prefix=True)

    # Get all policies, full path in nested folders
    # value = ConsulClient.get_kvs('0b231f372c6f42a89817a097549f4af5_green-eggs-and-ham:policies/items/')

    # Get all policies, full path in key, not nested
    # value = ConsulClient.get_kvs('0b231f372c6f42a89817a097549f4af5_green-eggs-and-ham:policies/items/', nest=False)

    # Get one policy
    # value = ConsulClient.get_value('0b231f372c6f42a89817a097549f4af5_green-eggs-and-ham:policies/items/DCAE_FTL3B.Config_In_Service')


    # Get dmaap values
    # value = ConsulClient.get_value('03dfc0cf63684e8b9e044ae75c42c9de_docker-highlandpark:dmaap')


    # Demonstrate add and delete VNF instance compatibility with the old <scn>:dti key
    # scn = '0b231f372c6f42a89817a097549f4af5_green-eggs-and-ham'
    # vnf_type = 'anot-her'
    # vnf_id = 'bogus_instance'
    # dti_event = {"dti":"event"}
    # all_dti_events = ConsulClient.add_vnf_id(scn, vnf_type, vnf_id, dti_event)
    #
    # all_dti_events = ConsulClient.delete_vnf_id(scn, vnf_type, vnf_id)
    # value = ConsulClient.get_value('0b231f372c6f42a89817a097549f4af5_green-eggs-and-ham:dti')
