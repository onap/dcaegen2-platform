...
#CLASSPATH=$CLASSPATH:$VCC_HOME/config/dtiProc/:$VCC_HOME/lib/common.jar:$VCC_HOME/lib/attMaven/*
CLASSPATH=$CLASSPATH:$VCC_HOME/lib/configManager.jar:$VCC_HOME/lib/common.jar:$VCC_HOME/lib/attMaven/*:$VCC_HOME/config/dtiproc/:$VCC_HOME/lib/dti-package-content-final.jar
